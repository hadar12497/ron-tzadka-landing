...
const faqs = [
  {
    ...
    answer: "השאירי פרטים ונחזור אלייך עם התאריך, השעות והמיקום של המחזור הקרוב.",
  },
  {
  ...
  {
    question: "למה סדנה ולא עוד ניסיון לבד?",
    answer: "כי הרבה יותר קל להתמיד כשיש מסגרת, תפריטים ברורים, מתכונים פשוטים, קבוצת נשים וליווי מקצועי לאורך הדרך.",
  },
  {
    ...
    <main className="limor-page">
      ...
      <section className="limor-contact-section" id="contact">
        <Reveal className="limor-contact-card">
          ...
          <p>השאירי פרטים ונחזור אלייך עם כל הפרטים על הסדנה, השעות וההרשמה.</p>
          <ContactForm
            ...
            goalPlaceholder="לדוגמה: אני רוצה לרדת במשקל, לקבל מסגרת ולהבין איך לאכול נכון ביום-יום."
            submitLabel="השארת פרטים להרשמה"
            idleMessage="הפרטים נשלחים לצורך חזרה עם פרטי הסדנה וההרשמה."
          />
        </Reveal>
      </section>
      ...
      <section className="limor-final">
        <Reveal>
          ...
          <h2>אם את רוצה להצטרף למחזור הקרוב, השאירי פרטים ונחזור אלייך.</h2>
